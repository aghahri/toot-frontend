    ...
    <main className="theme-page-bg theme-text-primary mx-auto w-full max-w-md space-y-5 px-4 pb-16 pt-4 sm:pb-14" dir="rtl">
      ...
      <section className={SECTION}>
        <Link
          ...
          className="flex items-center justify-between rounded-2xl border border-amber-200/70 bg-[linear-gradient(135deg,#FFF1E6,#FDE5D1)] px-3 py-3 text-right"
        >
          <div className="min-w-0">
            <p className="text-sm font-black text-amber-900">کسب‌وکارها</p>
            <p className="mt-1 text-[11px] leading-relaxed text-amber-800">فهرست خدمات و مشاوره آنلاین</p>
          </div>
